...
ChatLogic::ChatLogic()
{
    ...
    // Can be commented since chat bot is instantiated on the stack
...
ChatLogic::~ChatLogic()
{
    ...
    // Can be commented out since nodes and edges became unique ptrs
    // and chat bot is instantiated on the stack
